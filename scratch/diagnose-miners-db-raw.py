...
def main():
    ...
    queries = [
        ("Miners Catalog", "SELECT id, name, slug, image_url, source_type FROM miners ORDER BY id;"),
        ("Auto Mining Rewards Catalog", "SELECT id, name, slug, image_url, is_active FROM auto_mining_rewards ORDER BY id;")
    ]
