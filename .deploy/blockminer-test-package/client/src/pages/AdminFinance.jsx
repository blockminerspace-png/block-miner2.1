...
export default function AdminFinance() {
    ...
    const [telegramHealth, setTelegramHealth] = useState(null);
    ...
    const queueTelegramPrivateTest = async () => {
        try {
            ...
            toast.error(err.response?.data?.message || 'Erro ao enfileirar teste privado');
        } finally {
    ...
    const queueTelegramPublicTest = async () => {
        ...
        try {
            ...
            toast.error(err.response?.data?.message || 'Erro ao enfileirar teste público');
        } finally {
            setTelegramSaving(false);
        }
    };

    const retryTelegramEvent = async (eventId) => {
        try {
            ...
            toast.error(err.response?.data?.message || 'Erro ao reenviar evento');
        }
    };
