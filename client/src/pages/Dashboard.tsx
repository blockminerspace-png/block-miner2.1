...
import { safeDashboardNumber, sanitizeDashboardReferralCode } from '../utils/dashboardInputGuards';
...
export default function Dashboard(): ReactElement {
  ...
  const handleLinkReferral = async () => {
    ...
    setLinkingRef(true);
    try {
      const res = await api.post<{ ok?: boolean; message?: string }>('/user/link-referral', {
        refCode: sanitized,
      });
      if (res.data.ok) {
