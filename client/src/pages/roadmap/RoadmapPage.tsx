...
const MILESTONES: RoadmapMilestone[] = [
  {
    ...
    items: [
      ...
      { icon: ShieldCheck,  label: 'Autenticação 2FA (Email)',          status: S.LAUNCHED },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: MousePointerClick, label: 'PTC — Zerads',                 status: S.LAUNCHED },
      { icon: Globe,             label: 'Offerwall Externo',            status: S.LAUNCHED },
      ...
      { icon: BookOpen,          label: 'Read & Earn',                  status: S.LAUNCHED },
    ],
  },
  {
    phase: 'Fase 3',
    ...
    items: [
      ...
      { icon: Gamepad2,      label: '2048 Crypto',                      status: S.LAUNCHED },
      ...
      { icon: Swords,        label: 'PTP — Torneios Pagos',             status: S.LAUNCHED },
    ],
  },
  {
    phase: 'Fase 4',
    ...
    status: S.LAUNCHED,
    items: [
      { icon: Star,   label: 'Tarefas Diárias / Quests',            status: S.LAUNCHED },
      { icon: Rocket, label: 'Mini Pass & Battle Pass',             status: S.LAUNCHED },
      { icon: Zap,    label: 'Power Boost (multiplicador temp.)',   status: S.LAUNCHED },
      { icon: Eye,    label: 'Portal de Transparência On-chain',    status: S.LAUNCHED },
      { icon: Gift,   label: 'Cofre (Vault) de Recompensas',        status: S.LAUNCHED },
      { icon: Globe,  label: 'Mais Parceiros Offerwall',            status: S.PLANNED  },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Swords, label: 'Torneios & Competições Rankeadas',    status: S.PLANNED },
      { icon: Gem,    label: 'Boosters Raros na Loja',              status: S.PLANNED },
    ],
  },
  {
    phase: 'Fase 6',
    ...
    items: [
      ...
      { icon: Layers,     label: 'Token BLT — Economia Interna',      status: S.PLANNED },
    ],
  },
];
