...
function FaqItem({ id, question, answer, light }: { id: string; question: string; answer: string; light: boolean }) {
...
export default function Landing() {
  ...
  const featureCards: { icon: LucideIcon; titleKey: string; bodyKey: string }[] = [
