...
export type InternalOfferwallFormInput = Record<string, unknown>;

export type InternalOfferwallValidateOk = { ok: true };
export type InternalOfferwallValidateErr = { ok: false; i18nKey: string };
export type InternalOfferwallValidateResult = InternalOfferwallValidateOk | InternalOfferwallValidateErr;

/**
 * Client-side validation aligned with server parseAdminOfferBody / normalizeTaskMetadata.
 */
export function validateAdminInternalOfferwallForm(form: InternalOfferwallFormInput): InternalOfferwallValidateResult {
