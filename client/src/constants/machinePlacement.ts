 ...
 * @returns {string}
 */
export function placementFromBackendLocation(backendLocation: string | null | undefined): string {
 ...
 * @returns {boolean}
 */
export function isVaultPlacementStatus(status: string | null | undefined): boolean {
