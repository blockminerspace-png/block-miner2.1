...
interface TransparencyErrorBoundaryProps {
  children?: ReactNode;
}

interface TransparencyErrorBoundaryState {
  hasError: boolean;
  error: Error | null;
}

export default class TransparencyErrorBoundary extends Component<
  TransparencyErrorBoundaryProps,
  TransparencyErrorBoundaryState
> {
  constructor(props: TransparencyErrorBoundaryProps) {
    super(props);
    this.state = { hasError: false, error: null };
    this.handleReset = this.handleReset.bind(this);
  }

  static getDerivedStateFromError(error: unknown): Partial<TransparencyErrorBoundaryState> {
    return {
      hasError: true,
