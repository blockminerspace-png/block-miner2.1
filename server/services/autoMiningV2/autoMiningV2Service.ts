...
import { getBoostTtlMs } from "../powerBoostService.js";
 ...
 */
export async function sumDailyGrantedHash(userId, serverNow, tx: DbClient = prisma) {
 ...
 * @param {number} userId
 */
export async function deactivateUserSessions(userId, tx: DbClient = prisma) {
