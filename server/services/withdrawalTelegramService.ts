...
export function buildPolygonscanTxUrl(txHash: unknown, baseUrl: unknown = process.env.POLYGONSCAN_BASE_URL): string {
...
type WithdrawalTelegramTx = Pick<PrismaClient, "telegramOutboxEvent">;
...
function snapshotUsername(transaction: WithdrawalLike | null | undefined): string | null {
...
function publicPayloadForEvent(
  type: string,
