...
export async function run(sql: string, params: unknown[] = []): Promise<{ changes: number; lastID: null }> {
...
export async function all(sql: string, params: unknown[] = []): Promise<unknown> {
