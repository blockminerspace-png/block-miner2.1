...
const logger = loggerLib.child("adminOfferEvent");
...
export async function adminListOfferEvents(req: Request, res: Response) {
  try {
...
export async function adminCreateOfferEvent(req: Request, res: Response) {
  try {
...
export async function adminGetOfferEvent(req: Request, res: Response) {
  try {
...
export async function adminUpdateOfferEvent(req: Request, res: Response) {
  try {
    const id = Number(req.params.id);
    if (!Number.isInteger(id) || id <= 0) {
      return res.status(400).json({ ok: false, message: "Invalid id." });
...
export async function adminSoftDeleteOfferEvent(req: Request, res: Response) {
  try {
    const id = Number(req.params.id);
    if (!Number.isInteger(id) || id <= 0) {
      return res.status(400).json({ ok: false, message: "Invalid id." });
...
export async function adminListEventMiners(req: Request, res: Response) {
  try {
...
export async function adminCreateEventMiner(req: Request, res: Response) {
  try {
    const eventId = Number(req.params.eventId);
    if (!Number.isInteger(eventId) || eventId <= 0) {
      return res.status(400).json({ ok: false, message: "Invalid event id." });
...
export async function adminUpdateEventMiner(req: Request, res: Response) {
  try {
    const eventId = Number(req.params.eventId);
...
export async function adminRemoveEventMiner(req: Request, res: Response) {
  try {
    const eventId = Number(req.params.eventId);
    const minerId = Number(req.params.minerId);
    const existing = await prisma.eventMiner.findFirst({
...
export async function adminListEventPurchases(req: Request, res: Response) {
  try {
