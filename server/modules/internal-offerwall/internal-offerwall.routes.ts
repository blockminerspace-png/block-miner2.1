...
internalOfferwallRouter.get("/status", requireVisibleSidebarPath(internalOfferwallPath), limiter, ctrl.getFeatureStatus);
internalOfferwallRouter.get("/offers", requireAuth, requireVisibleSidebarPath(internalOfferwallPath), limiter, ctrl.getOffers);
