...
function iso(d: unknown): string | null {
  if (d && typeof d === "object" && d !== null && "toISOString" in d && typeof (d as { toISOString: () => string }).toISOString === "function") {
 ...
 */
export async function getPowerStats(req: Request, res: Response) {
  try {
